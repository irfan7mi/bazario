...
const Cart = () => {
  const {userId, email, setEmail, product_list, cartItem, setCartItem, removeFromCart, totalFromCart, url} = useContext(StoreContext)
  const [promo, setPromo] = useState(false)
  const [showPaymentForm, setShowPaymentForm] = useState(false);
  const [togglePromoPay, setTogglePromoPay] = useState(true)
  ...
  return (
    <div className='cart-container'>
      <div className="cart-items">
        ...
        <hr className='h-line'/>
        {Object.keys(cartItem).length > 0 && product_list.length > 0 ? (
      ...
      <div className="cart-bottom">
        ...
        <div className="cart-total">
          ...
          {(promo && (showPaymentForm && togglePromoPay)) 
        ...
        {(showPaymentForm && !togglePromoPay) ? (
              <PaymentForm onPaymentComplete={handlePaymentComplete} togglePromoPay = {setTogglePromoPay}/>
        ) : (
        <>
        </>
        )}
